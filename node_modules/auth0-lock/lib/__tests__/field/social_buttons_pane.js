...
describe('SocialButtonsPane', function () {
  ...
  it('renders big buttons when bigButtons === true', function () {
    var SocialButtonsPane = getComponent();
    (0, _testUtils.expectComponent)(_react2.default.createElement(SocialButtonsPane, _extends({}, defaultProps, { bigButtons: true }))).toMatchSnapshot();
  });
